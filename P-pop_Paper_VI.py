...
from StarCatalogs import CrossfieldBrightSample, ExoCat_1, LTC_2, LTC_3, LTC_4
...
StarCatalog = LTC_4 # LIFE Target Catalog (version 4)
...
# StypeToModel = {'A': EarthTwin, 'F': EarthTwin, 'G': EarthTwin, 'K': EarthTwin, 'M': EarthTwin}
# Scenario = 'baseline'
...
FigDir = 'Figures_PaperVI/' # str, should end with a slash ("/")
# block = True
block = False

# Select a name for the output planet population table and how many universes
# should be simulated.
Name = 'PaperVIPopulation' # str
Nuniverses = 1000 # int
